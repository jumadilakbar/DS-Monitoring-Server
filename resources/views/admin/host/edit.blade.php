                        ...
                        {{ csrf_field() }}
                           <h5 class="card-title">Setting Host :</h5>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input required name="Hostname" id="exampleEmail"  
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input required name="ip_address" id="exampleEmail" 
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input required name="port" id="exampleEmail" placeholder="1534"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                    <input required name="cpu" id="exampleEmail" placeholder="<50 or >=50" value="{{ $p->prm_cpu }}" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="position-relative row form-group">
                                <label for="exampleEmail" class="col-sm-2 col-form-label">RAM</label>
                                <div class="col-sm-10">
                                    <input required name="ram" id="exampleEmail" placeholder="<50 or >=50" value="{{ $p->prm_ram }}" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="position-relative row form-group">
                                <label for="exampleEmail" class="col-sm-2 col-form-label">Hardisk</label>
                                <div class="col-sm-10">
                                    <input required name="disk" id="exampleEmail" placeholder="<50 or >=50" value="{{ $p->prm_disk }}" type="text" class="form-control">
                                </div>
                            </div>
